...
const FEATURES = [
  {
    ...
    desc: "Create captions that convert in seconds.",
    icon: "✍️",
  },
  {
    title: "Visual Scheduler",
    desc: "Drag & drop calendar for perfect timing.",
    icon: "🗓️",
  },
  {
    title: "Auto Comment Reply",
    desc: "Keep engagement flowing with AI replies.",
    icon: "💬",
  },
  {
    title: "Analytics Dashboard",
    desc: "Track growth with clear metrics.",
    icon: "📊",
  },
  {
    title: "Media Management",
    desc: "Organize your assets in one place.",
    icon: "🖼️",
  },
  {
    title: "Instant Publishing",
    desc: "Publish natively across platforms.",
    icon: "🚀",
  },
];
      ...
      >
        {FEATURES.map((f) => (
          <motion.div
            ...
            variants={card}
          >
            <div className="w-12 h-12 rounded-md bg-slate-700 flex items-center justify-center text-xl">
              {f.icon}
            </div>
